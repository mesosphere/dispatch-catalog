...
EOF
    ...
    for file in $(find starlark/$1 -name '*.star' -print | sed 's/[.]star$//g'); do
        ...
        echo "* [$(basename $file)]($(realpath --relative-to starlark/ $file).md)" >> docs/starlark/README.md
        echo "* [$(basename $file)]($(realpath --relative-to starlark/$1 $file).md)" >> docs/starlark/$1/README.md
    done
}
